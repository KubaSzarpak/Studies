...
public class GetParamsServ extends HttpServlet {
  ...
  private String resBundleServ;    // nazwa serwletu przygotowuj¹cego
                                   // sparmetryzowan¹ informacje

  // Domyœlne enkodowanie na platformie serwletu
  // - bêdzie potrzebne przy pobieraniu wartoœci parametrów
  private String myEncoding = System.getProperty("file.encoding");
                             ...
                             throws ServletException, IOException
  {
    ...
    // Utsalenie w³aœciwego kodowania zlecenia
