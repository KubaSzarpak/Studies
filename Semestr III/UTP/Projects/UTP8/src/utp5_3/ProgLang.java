...
public class ProgLang {
    ...
    public Map<String, Set<String>> getLangsMapSortedByNumOfProgs() {
        return sorted(getLangsMap(), ((Comparator<Map.Entry<String, Set<String>>>) (o1, o2) -> Integer.compare(o2.getValue().size(), o1.getValue().size())).thenComparing(Map.Entry::getKey));
    }

    public Map<String, Set<String>> getProgsMapSortedByNumOfLangs() {
        return sorted(getProgsMap(), ((Comparator<Map.Entry<String, Set<String>>>) (o1, o2) -> Integer.compare(o2.getValue().size(), o1.getValue().size())).thenComparing(Map.Entry::getKey));
    }
